...
$.fn.toggleARIA = function(opts) {
  ...
  var will_collapse_class = 'toggle_down';
  var will_expand_class = 'toggle_up';
  ...
  function collapse(el) {
    ...
    $toggle.removeClass(will_collapse_class);
    $toggle.addClass(will_expand_class);
  ...
  function expand(el) {
    ...
    $toggle.removeClass(will_expand_class);
    $toggle.addClass(will_collapse_class);
  ...
  if (options.tidySelf) {
    $(document).on('mouseup touchstart', function(e) {
      ...
      && !$(e.target).closest('[aria-expanded=true]').length ) {
        collapse($el);
      }
    });
  }
